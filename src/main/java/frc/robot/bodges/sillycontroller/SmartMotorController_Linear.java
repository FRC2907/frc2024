...
public class SmartMotorController_Linear {
    ...
    private final VelocityVoltage talon_velocity = new VelocityVoltage(0, 0, false, 0, 1, false, false, false);
    ...
    public void setPosition(Measure<Distance> r) {
        ...
        switch (type) {
            ...
            case TALON_FX:
            // TODO verify units?
                talon.setControl(talon_position.withPosition(r.in(Units.Meters)));
                break;
            default:
                break;
        }
    ...
    public void setVelocity(Measure<Velocity<Distance>> r) {
        ...
        switch (type) {
            ...
            case TALON_FX:
            // TODO verify units?
                talon.setControl(talon_velocity.withVelocity(r.in(Units.MetersPerSecond)));
                break;
            default:
                break;
        }
