...
public class GameInteractions {
    public class arm {
        public static final Measure<Angle> kStartPosition = Units.Degrees.of(0.0); /// TODO[empirical]
        public static final Measure<Angle> kFloorPosition = Units.Degrees.of(0.0); /// TODO[empirical]
        public static final Measure<Angle> kAmpPosition = Units.Degrees.of(100.0); /// TODO[empirical]
        public static final Measure<Angle> kHoldingPosition = Units.Degrees.of(20.0); /// TODO[empirical]
        public static final Measure<Angle> kClimbReadyPosition = Units.Degrees.of(90.0); /// TODO[empirical]
        public static final Measure<Angle> kClimbClumbPosition = Units.Degrees.of(30.0); /// TODO[empirical]
        public static final Measure<Angle> kSelfRightingPosition = MechanismConstraints.arm.kMaxPosition; /// TODO[empirical]
        
        public static final Measure<Velocity<Angle>> kManualControlSpeed = Units.DegreesPerSecond.of(10.0); /// TODO[empirical]
    }
