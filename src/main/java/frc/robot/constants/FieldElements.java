...
public class FieldElements {
    ...
    public class y {
      ...
      public static final Measure<Distance> kMidfield = kField.divide(2.0);
        public static final List<Measure<Distance>> kMidfieldNotes = List.of(
              kMidfield.plus(Units.Inches.of(66 * 2))
            , kMidfield.plus(Units.Inches.of(66 * 1))
            , kMidfield
            , kMidfield.minus(Units.Inches.of(66 * 1))
            , kMidfield.minus(Units.Inches.of(66 * 2)));
      ...
      public class blue {
        ...
        public static final List<Measure<Distance>> kWingNotes = List.of(
              kMidfield
            , kMidfield.minus(Units.Inches.of(57 * 1).times(kOffsetDirection))
  ...
  public class points {
    ...
    public class blue {
      public static final Translation2d kSpeaker = new Translation2d(lengths.x.blue.kSpeakerCenter, lengths.y.blue.kSpeakerCenter);
      public static final Translation2d kAmp = new Translation2d(lengths.x.blue.kAmpCenter, lengths.y.blue.kAmpCenter);
      public static final Translation2d kStage = new Translation2d(lengths.x.blue.kStageCenter, lengths.y.blue.kStageCenter);
    ...
    public class red {
      public static final Translation2d kSpeaker = new Translation2d(lengths.x.red.kSpeakerCenter, lengths.y.red.kSpeakerCenter);
      public static final Translation2d kAmp = new Translation2d(lengths.x.red.kAmpCenter, lengths.y.red.kAmpCenter);
      public static final Translation2d kStage = new Translation2d(lengths.x.red.kStageCenter, lengths.y.red.kStageCenter);
  ...
  public class scoring_regions {
    public class blue {
      ...
      public static final ScoringRegion kSpeaker = ScoringRegion.of(
        new Pose2d(points.blue.kSpeaker, Rotation2d.fromDegrees(0))
        , Units.Inches.of(60).in(Units.Meters)
        , Units.Inches.of(120).in(Units.Meters)
  ...
  public class red {
      ...
      public static final ScoringRegion kSpeaker = ScoringRegion.of(
        new Pose2d(points.red.kSpeaker, Rotation2d.fromDegrees(180))
        , Units.Inches.of(60).in(Units.Meters)
        , Units.Inches.of(120).in(Units.Meters)
        , Rotation2d.fromDegrees(100)
      );
